...
# Function to get daily campaigns and their relavent metrics
...
# Function to get US true visits
...
# Function to get latest refresh date of each component of the pipeline
...
# Fetching latest dates of Source & Destination tables 
